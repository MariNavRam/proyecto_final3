        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @csrf
                ...
                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                    ...
                    <a href="{{ route('casas.index') }}"button type="submit"  class='w-auto bg-purple-500 hover:bg-purple-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Guardar</button>
                </div>
            </form>
